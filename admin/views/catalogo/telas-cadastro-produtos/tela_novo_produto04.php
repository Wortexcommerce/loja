...
<div class="form-group">
        	...
        	<input type="text" name="url_pagina_produto"  class="form-control" maxlength=150>
...
<div class="form-group">
        	...
        	<input type="text" name="titulo_pagina_produto" class="form-control" maxlength=150>
...
<div class="form-group">
        	...
        	<textarea class="form-control" name="descricao_pagina_produto" maxlength=400 style="height:200px"></textarea>
...
<div class="form-group">
        	...
        	<input type="text" name="palavras_chave_produto" maxlength=500 class="form-control" >
