                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control mascara-dinheiro" data-decimal="." name="preco_normal_produto" data-thousands="">
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">R$</span>
                            <input type="text" class="form-control mascara-dinheiro" data-thousands="" data-decimal="." name="preco_promocional_produto" >
                        </div>
