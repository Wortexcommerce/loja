...
<div class="col-md-6">
<h5><i class="fa fa-check-square-o fa-fw"></i>Redes Sociais</h5>
</div>
</div>
<hr>
...
<div class="row">
    ...
    <div class="col-md-6">
    	...
    	<div class="form-group">
    		<label  class="col-form-label">Nome da empresa/loja</label>
        ...
        <div class="form-group">
            <label  class="col-form-label">Complementp</label>
            <input type="text" class="form-control" id="inputEmail4">
        </div>
    ...
    <div class="col-md-6">
    	<div class="card">
        	<h6 class="card-header">Facebook</h6>
            <div class="card-body">
        ...
        <div class="card">
            <h6 class="card-header">Outros</h6>
            <div class="card-body">
